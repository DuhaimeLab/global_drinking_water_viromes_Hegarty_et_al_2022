...
### Looking at how rules add things
## Getting Score for Deciding Whether to Keep
...
### High confidence, keep if at least one of these
```{r}
viruses$keep_score[viruses$virsorter_category=="1"] <- 1
viruses$keep_score[viruses$virsorter_category=="4"] <- 1

viruses$keep_score[viruses$vibrant_original_quality=="high quality draft"] <- viruses$keep_score[viruses$vibrant_original_quality=="high quality draft"] + 1
viruses$keep_score[viruses$vibrant_original_quality=="medium quality draft"] <- viruses$keep_score[viruses$vibrant_original_quality=="medium quality draft"] + 1
...
viruses$keep_score[(viruses$viral>=50 & viruses$checkv_host_genes==0) & viruses$checkv_viral_genes==0] <- viruses$keep_score[(viruses$viral>=50 & viruses$checkv_host_genes==0) & viruses$checkv_viral_genes==0] + 1
```

```{r}
table(viruses$keep_score>=1)
```


### Medium confidence, keep if both of these
```{r}
viruses$keep_score[viruses$virsorter_category=="2"] <- viruses$keep_score[viruses$virsorter_category=="2"] + 0.7

viruses$keep_score[viruses$virfinder_score>=0.7] <- viruses$keep_score[viruses$virfinder_score>=0.7] + 0.7
```
...
### Low confidence, keep if in agreement with a medium
```{r}
viruses$keep_score[viruses$virsorter_category=="3"] <- viruses$keep_score[viruses$virsorter_category=="3"] + 0.3
viruses$keep_score[viruses$virsorter_category=="5"] <- viruses$keep_score[viruses$virsorter_category=="5"] + 0.3
viruses$keep_score[viruses$virsorter_category=="6"] <- viruses$keep_score[viruses$virsorter_category=="6"] + 0.3

viruses$keep_score[viruses$viral>=50] <- viruses$keep_score[viruses$viral>=50] + 0.3

viruses$keep_score[viruses$vibrant_original_quality=="low quality draft"] <- viruses$keep_score[viruses$vibrant_original_quality=="low quality draft"] + 0.3
...
### Remove things that high confidence, not viral
```{r}
viruses$keep_score[viruses$checkv_viral_genes==0 & viruses$checkv_host_genes>=1] <- 0
viruses$keep_score[(viruses$checkv_viral_genes*3) <= viruses$checkv_host_genes] <- 0
viruses$keep_score[viruses$checkv_length>50000 & viruses$hallmark==0] <- 0
viruses$keep_score[viruses$checkv_length>10000 & viruses$percent_host>viruses$percent_unknown] <- 0
```
